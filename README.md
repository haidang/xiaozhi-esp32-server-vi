[![Banners](docs/images/banner1.png)](https://github.com/haidang/xiaozhi-esp32-server-vi)

> **Fork tiếng Việt:** [haidang/xiaozhi-esp32-server-vi](https://github.com/haidang/xiaozhi-esp32-server-vi)
>
> Dự án này là **bản fork** của [xinnan-tech/xiaozhi-esp32-server](https://github.com/xinnan-tech/xiaozhi-esp32-server), tập trung tài liệu/hướng dẫn tiếng Việt và tùy biến cho Self-Host Server (ASR tiếng Việt, robot AI, v.v.).
>
> ## Bản quyền & giấy phép
>
> - **Giấy phép:** [MIT License](./LICENSE)
> - **Copyright gốc:** Copyright (c) 2025 [xinnan-tech](https://github.com/xinnan-tech) — giữ nguyên theo LICENSE upstream
> - **Fork / bản Việt:** Copyright (c) 2026 [haidang](https://github.com/haidang) — chỉ áp dụng cho phần chỉnh sửa, tài liệu tiếng Việt và tùy biến của fork này
> - Xem thêm [NOTICE](./NOTICE)
>
> Mọi bản phân phối phải giữ nguyên thông báo bản quyền và giấy phép MIT của phần mềm gốc.

---


<h1 align="center">Dịch vụ Backend Xiaozhi<br/>xiaozhi-esp32-server-vi</h1>
...
· <a href="https://github.com/haidang/xiaozhi-esp32-server-vi/issues">Báo cáo vấn đề</a>
· <a href="./README.md#tài-liệu-triển-khai">Tài liệu triển khai</a>
· <a href="https://github.com/xinnan-tech/xiaozhi-esp32-server/releases">Nhật ký cập nhật</a>
</p>

<p align="center">
  <a href="./docs/readme/README_zh-CN.md"><img alt="简体中文版自述文件" src="https://img.shields.io/badge/简体中文-DFE0E5"></a>
  ...
  <a href="https://github.com/haidang/xiaozhi-esp32-server-vi">
...
## Danh sách tính năng ✨
### Đã thực hiện ✅
![Kiến trúc cài đặt full module](docs/images/deploy2.png)
